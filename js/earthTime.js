...
function earthTime() {
	...
	if (hour >= 6 && hour < 7) {
		...
		document.getElementById('earth')
			.className = 'timeSunRise';
		document.getElementById('earthNight')
			.className = 'earthHide';
		document.getElementById('earthSunLow')
			.className = 'earthShow';
	} else if (hour >= 7 && hour < 12) {
		// Morning
		document.getElementById('earth')
			.className = 'timeMorning';
		document.getElementById('earthSunLow')
			.className = 'earthHide';
		document.getElementById('earthWarm')
			.className = 'earthShow';
	...
	// Add time to html
	document.getElementById('earthTime')
...
// Toggles The Time Travel Variable
function toggleTimeTravel() {
	if (timeTravel == false) {
		timeTravel = true;
		document.getElementById('timeTravel')
			.innerHTML = "Return to real time";
		document.getElementById('timeTravel')
			.className = 'timeTravelLarge';
		document.getElementById('earthTime')
			.innerHTML = "";
		document.getElementById('earthDate')
			.innerHTML = "";
	} else {
		timeTravel = false;
		earthDate();
...
// Checks For The Time Travel Variable
// Starts earthTime And earthTimeSpeed
...
function earthDate() {
	if (timeTravel == false) {
		...
		document.getElementById('earthDate')
			.innerHTML = today.getDate() + ' ' + months[today.getMonth()];
	}
}
